...
######################################################
            ...
            if instr[0:7] == "0100000":
                ...
                x[rd] = x[rs1] / pow(2,shamt)

                if(x[rd] < 0):
                    if(x[rd] != int(x[rd])):
                        x[rd] = x[rd] - 1

                #print(f"x[rd]: {x[rd]} x[rs1]: {x[rs1]} shamt: {shamt}")
...
#            rs2 = rs2 * 2 + a
        ...
        if instr[17:20] == "001":
            if instr[0:7] == "0000000":
                ...
                lower_five_bit = temp_rs2 % 32

                x[rd] = x[rs1] * pow(2, x[lower_five_bit])
        ...
        if instr[17:20] == "101":
            if instr[0:7] == "0000000":
                ...
                if(x[rs1] < 0):
                    ...
                    x[rd] = num / (pow(2,lower_five_bit))
                else:
                    #print(f"rs1: {x[rs1]} rs2: {x[rs2]}")
                    x[rd] = (x[rs1] / pow(2,lower_five_bit))
            ...
            if instr[0:7] == "0100000":
                ...
                if(x[rs1]<0):
#                    x[rd] = x[rs1]
                    x[rd] = (x[rs1] / pow(2,lower_five_bit)) % (-pow(2,32))
                else:
                    #print(x[rs2])
                    x[rd] = (x[rs1] / pow(2, lower_five_bit)) % pow(2,32)
...
#                print(f"x[rd]: {x[rd]} x[rs1]: {x[rs1]} x[rs2]: {x[rs2]}")
